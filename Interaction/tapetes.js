...
fetch('https://api.github.com/repos/erikprograming/CatalogoDecoracoes/contents/Imagens/Tapetes')
    .then(res => res.json())
    .then(arquivos => {
        let i = 0;
        ...
        function carregarProxima() {
            ...
            i++;
            setTimeout(carregarProxima, 150); // delay de 200ms entre cada imagem
        }
